            ...
            <ul>
              ...
              <div className="header__nav-links-container">
                <li
                  ...
                  data-aos-delay="200"
                > */}
                  <a href="https://github.com/eswar9110">GitHub</a>
                </li>
                <div className="header__route-bg"></div>
              </div>
              <div className="header__nav-links-container">
                <li
                  ...
                  data-aos-delay="300"
                >
                  <a href="www.linkedin.com/in/eswar-narayana-khande">Linkedin</a>
                </li>
                <div className="header__route-bg"></div>
              </div>
              <div className="header__nav-links-container">
                <li
                  ...
                  data-aos-delay="400"
                >
                  <a href="https://youtu.be/4ii9gTQ4XjQ?si=LZd1ZyQPIt8OYTS8">Youtube</a>
                </li>
                <div className="header__route-bg"></div>
              </div>
              <div className="header__nav-links-container">
              ...
              <div className="header__social">
                <p className="header__linkedin">
                  <a href="www.linkedin.com/in/eswar-narayana-khande" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                </p>

                <p className='header__github'>
                  <a href="https://github.com/eswar9110" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faGithub} size="2x" /></a>
                </p>
