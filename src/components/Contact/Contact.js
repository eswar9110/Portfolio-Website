                    ...
                    <div className="contact__info" data-aos="fade-up">
                        <ul className="contact__info-details">
                            <li>
                                ...
                                <p>Email: eswarnarayanak@gmail.com</p>
                            </li>
                            <li className="contact__social">
                                <a href="www.linkedin.com/in/eswar-narayana-khande" target="_blank" rel="noopener noreferrer">
                                    <FontAwesomeIcon icon={faLinkedin} size="2x" />
                                </a>
                                <a href="https://github.com/eswar9110" target="_blank" rel="noopener noreferrer">
